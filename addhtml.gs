function addhtml() {
  ...
  var data = SpreadsheetApp.getActiveSheet().getRange(3, 5, lastRow, 1).getValues();
  var html = []
  ...
  //console.log(richTextData.values());
  //SpreadsheetApp.getActiveSheet().getRange(3, 5, lastRow, 1).setRichTextValues([richTextData[0]],[richTextData[1]])
